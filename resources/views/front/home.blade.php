        ...
        <div class="row pb-3">
            @if (getCategories()->isNotEmpty())
                @foreach (getCategories() as $category)
                    <div class="col-lg-3">
                        <div class="cat-card shadow h-100">
                            <div class="left">
                                @if ($category->image != '')
    ...
    <div class="container">
        ...
        <div class="card-body text-center mt-3">
            ...
            <div class="price mt-2">
                <span class="h5 text-primary mr-2"><strong>${{ $product->price }}</strong></span>
...
<section class="section-4">
    <div class="container">
        ...
        <div class="card-body text-center mt-3">
            ...
            <div class="price mt-2">
                <span class="h5 text-primary mr-2"><strong>${{ $latestProduct->price }}</strong></span>
                @if ($latestProduct->original_price)
                    <span class="h6 text-underline"><del>${{ $latestProduct->original_price }}</del></span>
                @endif
            </div>
        </div>
    </div>
